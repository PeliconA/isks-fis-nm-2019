...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    var operator = parseInt(deli[1],10); // 10 osnova številskega sistema, decimalno (od 2 do 36)
                                     // npr. parseInt("ff", 16) vrne 255 | ("100", 2) -> 4
    if (operator == 0) {
    ...
    res.write("Za test vpišite v brskalnikovo vrstico z naslovom: http://192.168.1.200:8080/1 <br>");
    res.write("ali: http://192.168.1.200:8080/0<br>");
    res.end("Vrednost operatorja: " + operator);
}).listen(8080, "192.168.1.200");